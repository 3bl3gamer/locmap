...
|:--------|--------:|--------:|-------:|:----|
| base    |   25.1  |    6.6  |   2.9  | KiB |
| regular |   46.5  |   13.4  |   5.6  | KiB |
| full    |   52.6  |   16.0  |   6.5  | KiB |
<!-- SIZE_TABLE_END -->
...
### new LocMap(wrap, conv) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L39)
...
#### register(layer) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L121)

 * `layer` *MapLayer*

#### unregister(layer) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L127)

 * `layer` *MapLayer*

#### updateLocation(lon_, lat_, level_) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L140)
...
#### move(dx, dy) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L319)
...
#### moveSmooth(dx, dy, stamp) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L337)
...
#### applyMoveInertia(dx, dy, stamp) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L353)
...
#### zoom(x, y, delta) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L281)
...
#### zoomSmooth(x, y, delta, stamp) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L304)
...
#### applyZoomInertia(x, y, delta, stamp) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L368)
...
#### emit(name, params) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L392)
...
#### get2dContext() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L83)

 * Returns: *null | CanvasRenderingContext2D*

#### getCanvas() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L82)

 * Returns: *HTMLCanvasElement*

#### getLat() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L53)

 * Returns: *number*

#### getLevel() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L54)

 * Returns: *number*

#### getLon() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L52)

 * Returns: *number*

#### getProjConv() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L60)

 * Returns: *ProjectionConverter*

Returns current projection config.

#### getViewBoxHeight() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L69)

 * Returns: *number*

Map view height.

#### getViewBoxWidth() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L67)

 * Returns: *number*

Map view width.

#### getViewBoxXShift() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L63)

 * Returns: *number*

Map left edge offset from the view left edge (in pixels).

#### getViewBoxYShift() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L65)

 * Returns: *number*

Map top edge offset from the view top edge (in pixels).

#### getWrap() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L81)

 * Returns: *HTMLElement*

#### getXShift() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L56)

 * Returns: *number*

Map left edge offset from the view center (in pixels).

#### getYShift() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L58)

 * Returns: *number*

Map top edge offset from the view center (in pixels).

#### getZoom() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L61)

 * Returns: *number*

#### lat2y(lat) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L99)

 * `lat` *number*
 * Returns: *number*

#### lon2x(lon) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L95)

 * `lon` *number*
 * Returns: *number*

#### meters2pixCoef(lat) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L103)

 * `lat` *number*
 * Returns: *number*

#### requestRedraw() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L239)

Schedules map redraw (unless already scheduled). Can be safelyl called multiple times per frame.

#### resize() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L261)

Should be called after map element (`wrap`) resize to update internal state and canvas.

#### x2lon(x) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L107)

 * `x` *number*
 * Returns: *number*

#### y2lat(y) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/map.js#L111)

 * `y` *number*
 * Returns: *number*


### new TileLayer(tileHost) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/tile_layer.js#L7)
...
### new TileContainer(tileW, pathFunc) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/tile_container.js#L25)
...
### new ControlLayer([mouseOpts][, kbdOpts]) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/control_layer.js#L363)
...
### new PointerControlLayer([opts]) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/control_layer.js#L54)
...
### new KeyboardControlLayer([opts]) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/control_layer.js#L303)
...
### new ControlHintLayer(controlText, twoFingersText[, opts]) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/control_layer.js#L387)
...
### new LocationLayer() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/location_layer.js#L21)

Watches current geolocation, draws a cross or a circle (depending on accuracy) on the map.


### new URLLayer() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/url_layer.js#L16)
...
#### appendCredit(wrap, html[, style]) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/utils.js#L28)
...
#### controlHintKeyName() [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/control_layer.js#L450)
...
#### oneOf(...args) [src](https://github.com/3bl3gamer/locmap/blob/e3086af/src/utils.js#L7)
