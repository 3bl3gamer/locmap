...
### <a name="user-content-locmap"></a>new LocMap(wrap, conv) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L39)
...
#### <a name="user-content-register"></a>register(layer) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L138)

 * `layer` *MapLayer*

#### <a name="user-content-unregister"></a>unregister(layer) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L144)

 * `layer` *MapLayer*

#### <a name="user-content-updatelocation"></a>updateLocation(lon_, lat_, zoom_) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L159)
...
#### <a name="user-content-move"></a>move(dx, dy) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L341)
...
#### <a name="user-content-movesmooth"></a>moveSmooth(dx, dy, stamp) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L359)
...
#### <a name="user-content-applymoveinertia"></a>applyMoveInertia(dx, dy, stamp) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L375)
...
#### <a name="user-content-zoom"></a>zoom(x, y, delta) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L304)
...
#### <a name="user-content-zoomsmooth"></a>zoomSmooth(x, y, delta, stamp) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L326)
...
#### <a name="user-content-applyzoominertia"></a>applyZoomInertia(x, y, delta, stamp) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L390)
...
#### <a name="user-content-emit"></a>emit(name, params) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L414)
...
#### <a name="user-content-get2dcontext"></a>get2dContext() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L100)

 * Returns: *null | CanvasRenderingContext2D*

#### <a name="user-content-getcanvas"></a>getCanvas() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L99)

 * Returns: *HTMLCanvasElement*

#### <a name="user-content-getlat"></a>getLat() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L53)

 * Returns: *number*

#### <a name="user-content-getlayers"></a>getLayers() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L151)

 * Returns: *readonly MapLayer\[\]*

#### <a name="user-content-getlon"></a>getLon() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L52)

 * Returns: *number*

#### <a name="user-content-getprojconv"></a>getProjConv() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L55)

 * Returns: *ProjectionConverter*

#### <a name="user-content-getshift"></a>getShift() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L60)

 * Returns: *\[x:number, y:number\]*

Map top-left edge offset from the view center (in pixels).

#### <a name="user-content-getviewboxshift"></a>getViewBoxShift() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L66)

 * Returns: *\[x:number, y:number\]*

Map top-left edge offset from the view top-left edge (in pixels).

#### <a name="user-content-getviewboxsize"></a>getViewBoxSize() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L71)

 * Returns: *\[x:number, y:number\]*

Map view size.

#### <a name="user-content-getwrap"></a>getWrap() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L98)

 * Returns: *HTMLElement*

#### <a name="user-content-getzoom"></a>getZoom() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L54)

 * Returns: *number*

#### <a name="user-content-getzoomrange"></a>getZoomRange() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L77)

 * Returns: *\[min:number, max:number\]*

Returns min and max zoom.

#### <a name="user-content-lat2y"></a>lat2y(lat) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L116)

 * `lat` *number*
 * Returns: *number*

#### <a name="user-content-lon2x"></a>lon2x(lon) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L112)

 * `lon` *number*
 * Returns: *number*

#### <a name="user-content-meters2pixcoef"></a>meters2pixCoef(lat) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L120)

 * `lat` *number*
 * Returns: *number*

#### <a name="user-content-requestredraw"></a>requestRedraw() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L257)

Schedules map redraw (unless already scheduled). Can be safelly called multiple times per frame.

#### <a name="user-content-resize"></a>resize() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L284)

Should be called after map element (`wrap`) resize to update internal state and canvas.

#### <a name="user-content-setzoomrange"></a>setZoomRange(min, max) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L83)
...
#### <a name="user-content-x2lon"></a>x2lon(x) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L124)

 * `x` *number*
 * Returns: *number*

#### <a name="user-content-y2lat"></a>y2lat(y) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/map.js#L128)

 * `y` *number*
 * Returns: *number*


### <a name="user-content-tilelayer"></a>new TileLayer(tileContainer) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/tile_layer.js#L17)
...
### <a name="user-content-smoothtilecontainer"></a>new SmoothTileContainer(tileW, tileLoadFunc\[, tilePlaceholderDrawFunc\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/tile_container.js#L64)
...
### <a name="user-content-controllayer"></a>new ControlLayer(\[mouseOpts\]\[, kbdOpts\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/control_layer.js#L410)
...
### <a name="user-content-pointercontrollayer"></a>new PointerControlLayer(\[opts\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/control_layer.js#L80)
...
### <a name="user-content-keyboardcontrollayer"></a>new KeyboardControlLayer(\[opts\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/control_layer.js#L350)
...
### <a name="user-content-controlhintlayer"></a>new ControlHintLayer(controlText, twoFingersText\[, opts\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/control_layer.js#L434)
...
### <a name="user-content-locationlayer"></a>new LocationLayer() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/location_layer.js#L21)

Watches current geolocation, draws a cross or a circle (depending on accuracy) on the map.


### <a name="user-content-urllayer"></a>new URLLayer(\[lonLatPrec\]\[, levelPrec\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/url_layer.js#L18)
...
#### <a name="user-content-appendcredit"></a>appendCredit(wrap, html\[, style\]) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/utils.js#L28)
...
#### <a name="user-content-clampearthtiles"></a>clampEarthTiles(tileFunc) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/tile_container.js#L420)
...
#### <a name="user-content-controlhintkeyname"></a>controlHintKeyName() [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/control_layer.js#L496)
...
#### <a name="user-content-drawrecttileplaceholder"></a>drawRectTilePlaceholder(map, x, y, z, drawX, drawY, tileW, scale) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/tile_container.js#L440)
...
#### <a name="user-content-loadtileimage"></a>loadTileImage(pathFunc) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/tile_container.js#L391)
...
#### <a name="user-content-oneof"></a>oneOf(...args) [src](https://github.com/3bl3gamer/locmap/blob/5075740/src/utils.js#L7)
